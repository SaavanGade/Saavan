...
nb_path: _notebooks/2022-12-11-Unit-3-Sections-14-15-lesson copy.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-12-11-Unit-3-Sections-14-15-lesson copy.ipynb
-->
...
<html>
    <script>
        function answerIs(){
        document.getElementById("answer").innerHTML = "- Libraries are usually included in a program using a special keyword called “import”. This keyword tells the program to look for the library and use its code.";
    }
        </script>
        <button onClick = "answerIs()" style = "background-color: #eb3734; color: #FFFF; border-color:#FFFF; font-size: 1.5em">Reveal Answer</button>
        <p id ="answer">- Libraries are usually included in a program using a special keyword called " ." This keyword tells the program to look for the library and use its code.</p>
        <script>       
  </html>
</div>
</div>
...
</html><p>1) In your own words, what is a library?
2) Why are libraries useful when writing a program?
3) What keyword is used to add a pre-made library?</p>
...
<p><strong><strong> Does anyone want to tell us an example of randomization during our day to day life. </strong></strong></p>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>What is the range of answer 3?</p>
